...
export default function Onboarding({ onComplete }: { onComplete: () => void }) {
  ...
  const steps = [
...

    {
      ...
      subtitle: "Philosophy",
      content:
        "Connect with the divine through love and devotion, not fear. We guide you to perform rituals with understanding and pure intent.",
        ...
        <div className="space-y-6 w-full max-w-xs mx-auto text-left">
          ...
          <div className="flex items-start gap-4 p-4 rounded-2xl bg-orange-50 border border-orange-100">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500 mt-1">
                Get daily reminders for your Jaap and family events.
              </p>
            </div>
          ...
          <div className="flex items-start gap-4 p-4 rounded-2xl bg-orange-50 border border-orange-100">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500 mt-1">
                For accurate sunrise/sunset times in your Panchang.
              </p>
            </div>
  ...
  const isPersonalizationInvalid =
    step === 3 &&
    (
      !preferences.city.trim() ||
      !preferences.deity
    ...
    <div className="min-h-screen bg-transparent flex flex-col max-w-md mx-auto relative overflow-hidden">
      ...
      <div className="p-8 pb-12">
        ...
        <button
          ...
          className={`w-full py-4 rounded-2xl text-white font-medium text-lg shadow-lg flex items-center justify-center gap-2 transition-colors ${
            isPersonalizationInvalid

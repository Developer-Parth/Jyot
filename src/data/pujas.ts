...
export const pujas: Puja[] = [
  {
    ...
    steps: [
      { step: 1, title: 'Purification', titleHi: 'शुद्धिकरण', instruction: 'Sit facing East or North and take three small sips of water with a calm mind.', instructionHi: 'पूर्व या उत्तर दिशा की ओर बैठकर शांत मन से तीन बार जल ग्रहण करें।', mantra: 'Om Keshavaya Namah, Om Narayanaya Namah, Om Madhavaya Namah' },
      ...
      { step: 3, title: 'Abhishekam', titleHi: 'अभिषेक', instruction: 'Offer water, milk, and water again to the Shiva Linga while chanting.', instructionHi: 'शिवलिंग पर जल, दूध और पुनः जल अर्पित करते हुए मंत्र जप करें।', mantra: 'Om Namah Shivaya' },
  ...
  },
  {
    ...
    steps: [
      ...
      { step: 2, title: 'Ganesh Vandana', titleHi: 'गणेश वंदना', instruction: 'Begin with Lord Ganesha prayers for a smooth puja.', instructionHi: 'निर्विघ्न पूजा के लिए भगवान गणेश की वंदना करें।', mantra: 'Om Gan Ganapataye Namah' },
      ...
      { step: 4, title: 'Prasad Offering', titleHi: 'प्रसाद अर्पण', instruction: 'Offer panchamrit, fruits, and sweets to Lord Vishnu.', instructionHi: 'भगवान विष्णु को पंचामृत, फल और मिठाई अर्पित करें।', mantra: 'Om Namo Bhagavate Vasudevaya' },
  ...
  },
  {
    ...
    steps: [
      ...
      { step: 2, title: 'Invoke Ganesha', titleHi: 'गणेश आवाहन', instruction: 'Invite Lord Ganesha with folded hands and a steady mind.', instructionHi: 'हाथ जोड़कर स्थिर मन से भगवान गणेश का आवाहन करें।', mantra: 'Om Gan Ganapataye Namah' },
      ...
      { step: 4, title: 'Aarti', titleHi: 'आरती', instruction: 'Perform Ganesh aarti with camphor or diya.', instructionHi: 'कपूर या दीपक से गणेश आरती करें।', mantra: 'Jai Ganesh Deva' }
    ]
  },
  {
    id: 4,
    ...
    steps: [
      ...
      { step: 4, title: 'Durga Invocation', titleHi: 'दुर्गा आवाहन', instruction: 'Invoke Maa Durga and chant the mantra with devotion.', instructionHi: 'भक्ति भाव से मां दुर्गा का आवाहन करें और मंत्र जपें।', mantra: 'Ya Devi Sarva Bhuteshu Shakti Rupena Samsthita' }
    ]
  },
  {
    id: 5,
    ...
    steps: [
      ...
      { step: 3, title: 'Chalisa Path', titleHi: 'चालीसा पाठ', instruction: 'Recite Hanuman Chalisa with focus and humility.', instructionHi: 'एकाग्रता और विनम्रता से हनुमान चालीसा का पाठ करें।', mantra: 'Shri Guru Charan Saroj Raj, Nij Man Mukur Sudhari' },
